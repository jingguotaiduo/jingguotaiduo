...
- 🌱 I’m currently learning in WHU in China, and have learned many languages,such as C、C++、C#、Matlab、Java、Python、Scala VB and so on. I have used some professional softwares,such as ArcGIS、AutoCAD、ENVI、Matlab,some IDE likes Micorsoft Visual Stuido、Eclipse、IDEA、PyCharm.....
