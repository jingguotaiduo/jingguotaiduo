...
- 
- 🌱 I’m have learned many languages,such as C、C++、C#、Matlab、Java、Python、Scala、VB、JavaScript and so on. 
- 
- I have used some professional softwares,such as ArcGIS、QGIS、AutoCAD、ENVI、Matlab,some IDEs like Micorsoft Visual Stuido、Eclipse、VS Code、IDEA、PyCharm、WebStorm、CodeBlocks.....
- 
